...
const file_grpc_proto_proto_rawDesc = "" +
	...
	"\tTimestamp\x18\x01 \x01(\x03R\tTimestamp\x12\x1a\n" +
	"\bCallerId\x18\x02 \x01(\x03R\bCallerId2\x92\x02\n" +
	"\x04Node\x12\x18\n" +
	"\x03Bid\x12\v.BidMessage\x1a\x04.Ack\x12\"\n" +
	"\x06Result\x12\x0e.ResultMessage\x1a\b.Outcome\x12\x1e\n" +
	"\n" +
	"AuctionEnd\x12\x06.Empty\x1a\b.Outcome\x12$\n" +
...
var file_grpc_proto_proto_depIdxs = []int32{
	...
	3, // 2: Node.AuctionEnd:input_type -> Empty
	5, // 3: Node.Election:input_type -> ElectionMessage
	6, // 4: Node.Answer:input_type -> AnswerMessage
	4, // 5: Node.Coordinator:input_type -> CoordinatorMessage
	3, // 6: Node.Ping:input_type -> Empty
	0, // 7: Node.Sync:input_type -> BidMessage
	1, // 8: Node.Bid:output_type -> Ack
	2, // 9: Node.Result:output_type -> Outcome
	2, // 10: Node.AuctionEnd:output_type -> Outcome
	3, // 11: Node.Election:output_type -> Empty
	3, // 12: Node.Answer:output_type -> Empty
	3, // 13: Node.Coordinator:output_type -> Empty
	3, // 14: Node.Ping:output_type -> Empty
	0, // 15: Node.Sync:output_type -> BidMessage
